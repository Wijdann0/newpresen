...
.jurusan:hover {
  background-color: lightblue; /* Warna latar belakang berubah saat hover */
  border-color: blue; /* Warna border berubah saat hover */
}
...
.col-md-6 {
  flex: 1;
  min-width: 240px; /* Menjaga lebar minimal agar responsif */
}
