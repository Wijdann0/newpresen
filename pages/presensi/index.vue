            ...
            <div class="row mb-5">
              <div class="col-md-6">
                <select v-model="form.jurusan" :disabled="form.tingkat == ''"
                  class="jurusan form-control form-control-lg rounded-4 fs-3 text-center" style="padding-bottom: 10px">
        ...
        <form @submit.prevent="kirimData">
          ...
          <div class="mb-4">
            <div class="row mb-5">
              ...
              <div class="col-md-6">
                <select @change="cek" class="jurusan form-control form-control-lg rounded-4 fs-5 text-center">
                  <option value="">KELAS</option>
                  <option value="1">1</option>
                  <option value="2">2</option>
                  <option value="3">3</option>
          ...
          <div class="row">
            <div class="col-12 d-flex justify-content-center">
              <select v-model="form.siswa" class="form-control form-control-lg nama fs-5 text-center mb-5 w-100">
                <option value="">Nama</option>
                <option v-for="(member, i) in members" :key="i" :value="member.id">{{ member.nama }}</option>
              </select>
            </div>
            <div class="col-12 d-flex justify-content-center">
              <select v-model="form.keterangan" :disabled="form.jurusan == ''"
                class="form-control form-control-lg nama fs-5 text-center mb-5 w-100">
                <option value="">Keterangan</option>
                <option v-for="(item, i) in objectives" :key="i" :value="item.id">{{ item.nama }}</option>
              </select>
            </div>
